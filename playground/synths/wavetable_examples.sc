("../../synths/wavetable.sc").loadRelative;
...
~bass.play(numChannels:2);
~bass.xset(\amp, 0.6);
~bass.xset(\scale, nil);
~bass.set(\scale, Scale.minorPentatonic);
~base.set(\root, -3);
~base.set(\octave, 1);
~bass.release;
~bass.end;
