...
(
  x.set(
    ...
    \wave, 12, //waveform selector 0 to 89 waveform
    \detune, 2.midiratio, //detune parameter of the second oscillator
    ...
    \lfo1type1, 5, // LFO of 1st filter choose between 6 waveforms: 0=Sine, 1=Triangle, 2=Up Saw, 3=Down Saw, 4=Pulse, 5=Stepped Random
    \rate1, 2, // Rate of 1st LFO in Hz
    \depth1, 0.6, // Depth of 1st LFO in Hz, 1 means no modulation, 0 is max
    \alias, 44100/30, // Sample rate reduction in Hz
    \redux, 8, // Bit rate reduction between 0-24 bits

    \freq2, 700, // Cutoff frequency for the 2nd filter
    \res2, 0.3, // Resonance for filter2 (0..1)
    \lfo1type2, 4, // LFO of 2nd filter choose between 6 waveforms: 0=Sine, 1=Triangle, 2=Up Saw, 3=Down Saw, 4=Pulse, 5=Stepped Random
    \rate2, 0.04, // Rate of 2nd LFO in Hz
    ...
    \rate3, 1.2, // Rate of 3rd LFO in Hz
